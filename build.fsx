...
let project = "FSCS-Lensgenerator"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "FSCS-LensGenerator: generate lenses/optics for F# projects"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "FSCS-LensGenerator is a code generator that generates lenses/optics for your F# projects. Currently only Aether output is supported but we're open accept other output providers."

// List of author names (for NuGet package)
let authors = [ "QuestNet GmbH" ]

// Tags for your project (for NuGet package)
let tags = "Lens Optics CodeGeneration FSharp"

// File system information
let solutionFile  = "FSCS-Lensgenerator.sln"
...
let gitOwner = "questnet"
let gitHome = sprintf "%s/%s" "https://github.com" gitOwner

// The name of the project on GitHub
let gitName = "FSCS-Lensgenerator"

// The url for the raw files hosted
let gitRaw = environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/questnet"
